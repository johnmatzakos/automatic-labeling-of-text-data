...
save(reliable_sources, file = "reliable_sources-bow-tf.RData")
...
save(dtm, file = "dtm-bow-tf.RData")
...
save(dtm_df, file = "dtm_df-bow-tf.RData")
...
save(trainlabels, file = "trainlabels-bow-tf.RData")
save(testlabels, file = "testlabels-bow-tf.RData")
...
save(trainmat, file = "trainmat-bow-tf.RData")
save(testmat, file = "testmat-bow-tf.RData")
...
save(train_container, file = "train_container-bow-tf.RData")
save(test_container, file = "test_container-bow-tf.RData")

save.image("data_after_preprocessing-bow-tf.RData")
...
nb_confusion_matrix
write.csv(nb_confusion_matrix, file = "nb_confusion_matrix-bow-tf.csv")

nb_performance = analytics(nb_confusion_matrix)
nb_performance
write.csv(nb_performance, file = "nb_performance-bow-tf.csv")
...
write.csv(svm_confusion_matrix, file = "svm_confusion_matrix-bow-tf.csv")

svm_performance = analytics(svm_confusion_matrix)
svm_performance
write.csv(svm_performance, file = "svm_performance-bow-tf.csv")
...
rf_confusion_matrix
write.csv(rf_confusion_matrix, file = "rf_confusion_matrix-bow-tf.csv")

rf_performance = analytics(rf_confusion_matrix)
rf_performance
write.csv(rf_performance, file = "rf_performance-bow-tf.csv")
...
write.csv(tree_confusion_matrix, file = "tree_confusion_matrix-bow-tf.csv")

tree_performance = analytics(tree_confusion_matrix)
tree_performance
write.csv(tree_performance, file = "tree_performance-bow-tf.csv")
...
write.csv(slda_confusion_matrix, file = "slda_confusion-matrix-bow-tf.csv")

slda_performance = analytics(slda_confusion_matrix)
slda_performance
write.csv(slda_performance, file = "slda_performance-bow-tf.csv")
...
write.csv(maxent_confusion_matrix, file = "maxent_confusion_matrix-bow-tf.csv")

maxent_performance = analytics(maxent_confusion_matrix)
maxent_performance
write.csv(maxent_performance, file = "maxent_performance-bow-tf.csv")

save.image("workspace_sc-bow-tf.RData")
