...
save(reliable_sources, file = "reliable_sources-bow-tfidf.RData")
...
#create a dtm using term frequency-inverse document frequency
dtm = DocumentTermMatrix(corpus,control = list(weighting=function(x)weightTfIdf(x, normalize = T)))
save(dtm, file = "dtm-bow-tfidf.RData")
...
save(dtm_df, file = "dtm_df-bow-tfidf.RData")
...
save(trainlabels, file = "trainlabels-bow-tfidf.RData")
save(testlabels, file = "testlabels-bow-tfidf.RData")
...
save(trainmat, file = "trainmat-bow-tfidf.RData")
save(testmat, file = "testmat-bow-tfidf.RData")
...
save(train_container, file = "train_container-bow-tfidf.RData")
save(test_container, file = "test_container-bow-tfidf.RData")

save.image("data_after_preprocessing-bow-tfidf.RData")
...
nb_confusion_matrix
write.csv(nb_confusion_matrix, file = "nb_confusion_matrix-bow-tfidf.csv")

nb_performance = analytics(nb_confusion_matrix)
nb_performance
write.csv(nb_performance, file = "nb_performance-bow-tfidf.csv")
...
write.csv(svm_confusion_matrix, file = "svm_confusion_matrix-bow-tfidf.csv")

svm_performance = analytics(svm_confusion_matrix)
svm_performance
write.csv(svm_performance, file = "svm_performance-bow-tfidf.csv")
...
rf_confusion_matrix
write.csv(rf_confusion_matrix, file = "rf_confusion_matrix-bow-tfidf.csv")

rf_performance = analytics(rf_confusion_matrix)
rf_performance
write.csv(rf_performance, file = "rf_performance-bow-tfidf.csv")
...
write.csv(tree_confusion_matrix, file = "tree_confusion_matrix-bow-tfidf.csv")

tree_performance = analytics(tree_confusion_matrix)
tree_performance
write.csv(tree_performance, file = "tree_performance-bow-tfidf.csv")
...
write.csv(slda_confusion_matrix, file = "slda_confusion-matrix-bow-tfidf.csv")

slda_performance = analytics(slda_confusion_matrix)
slda_performance
write.csv(slda_performance, file = "slda_performance-bow-tfidf.csv")
...
write.csv(maxent_confusion_matrix, file = "maxent_confusion_matrix-bow-tfidf.csv")

maxent_performance = analytics(maxent_confusion_matrix)
maxent_performance
write.csv(maxent_performance, file = "maxent_performance-bow-tfidf.csv")

save.image("workspace_sc-bow-tfidf.RData")
